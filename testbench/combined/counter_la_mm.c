...
// reg_mprj_datal = 0xAB510000;
	...
	reg_mprj_datal = *(fir_tmp+4) << 16;
	reg_mprj_datal = *(fir_tmp+5) << 16;
	reg_mprj_datal = *(fir_tmp+6) << 16;
	reg_mprj_datal = *(fir_tmp+7) << 16;
	...
	reg_mprj_datal = 0xAB400000;
	int* qs_tmp = qsort();
	reg_mprj_datal = *qs_tmp << 16;
	reg_mprj_datal = *(qs_tmp+1) << 16;
	reg_mprj_datal = *(qs_tmp+2) << 16;
	reg_mprj_datal = *(qs_tmp+3) << 16;
	reg_mprj_datal = *(qs_tmp+4) << 16;
	reg_mprj_datal = *(qs_tmp+5) << 16;
	reg_mprj_datal = *(qs_tmp+6) << 16;
	reg_mprj_datal = *(qs_tmp+7) << 16;
	reg_mprj_datal = *(qs_tmp+8) << 16;
	reg_mprj_datal = *(qs_tmp+9) << 16;	
